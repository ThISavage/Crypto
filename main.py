...
"""--Code 1.txt --Key key.bin --File encode_text.txt --Vec vec.bin --Mod ECB"""
"""--Decode encode_text.txt --Key key.bin --File dectext.txt --Vec vec.bin --Mod ECB"""
"""--Code 1.txt --Key key.bin --File encode_text.txt --Vec vec.bin --Mod ICBC"""
"""--Decode encode_text.txt --Key key.bin --File dectext.txt --Vec vec.bin --Mod ICBC"""
"""--Code 1.txt --Key key.bin --File encode_text.txt --Vec vec.bin --Mod OCBC"""
"""--Decode encode_text.txt --Key key.bin --File dectext.txt --Vec vec.bin --Mod OCBC"""
"""--Code 1.txt --Key key.bin --File encode_text.txt --Vec vec.bin --Mod PAD"""
"""--Decode encode_text.txt --Key key.bin --File dectext.txt --Vec vec.bin --Mod PAD"""
